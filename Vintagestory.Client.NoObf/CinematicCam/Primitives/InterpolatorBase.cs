...
namespace Vintagestory.Client.NoObf.CinematicCam.Primitives
{
    ...
    internal abstract class InterpolatorBase : ICameraPointInterpolator
    {
        ...
        /// </summary>
        /// <param name="previous">The node before the last left behind node which is the same as the current node at the beginning of the path.</param>
        ...
        protected static double CubicCatmull(double previous, double current, double next, double subsequent, double step)
        {
